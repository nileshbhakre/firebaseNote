...
class _$NoteTearOff {
  ...
  _Note call({UniqueId? id, NoteTitle? title, NoteBody? body}) {
    return _Note(
      id: id,
      title: title,
      body: body,
...
abstract class $NoteCopyWith<$Res> {
  ...
  $Res call({UniqueId? id, NoteTitle? title, NoteBody? body});
}
...
class _$_Note implements _Note {
  const _$_Note({this.id, this.title, this.body});
...
abstract class _Note implements Note {
  const factory _Note({UniqueId? id, NoteTitle? title, NoteBody? body}) =
      _$_Note;
